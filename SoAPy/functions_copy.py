    ...
    for a in range(len(dir_list)):
        ...
        while conformer_count <= int(dir_parameters[a][5]):
            ...
            if dir_parameters[a][0] != "OptRot":
                ...
                test_frequencies.append(real_frequencies)       # Changed to append.
                test_intensities.append(real_intensities)       # Changed to append.
...
def generate_convergence_spectrum(fwhm, number_of_points, dir_list, dir_parameters, dir_frequencies, dir_intensities, min_frequency, max_frequency, snapshot_list):
    """
